...
export default function HeroSection(){
    return(
        <section className="hero-section">
            <div className="max-w-7xl mx-auto px-4 flex flex-col h-full md:flex-row items-center">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0 hero-image h-full flex justify-center items-center">
                    <Image src="/images/gorroLA.jpg" width={1000} height={1000} alt="Imagen del Producto" className="hero-image-wh rounded-lg shadow-lg bg-gray-100"/>
                </div>
            </div>
        </section>
    )
